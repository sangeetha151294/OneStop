...
public class GoogleLogin extends HttpServlet {
    ...
    private final static String getOAuthorizeURL = "https://accounts.google.com/o/oauth2/auth";
    private static String bearerToken;
    public static final String callback="http://localhost:8080/OneStop/google/redirect";
    public static final String CONSUMER_KEY = "972250650559-shof1koju5hval0b20rucafbb1qet4ia.apps.googleusercontent.com";
    public static final String CONSUMER_SECRET= "BYNxVA-JxeJt5FzKoPsUtMSK";
   // static String secretcode;
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, java.io.IOException { 
		  ...
		  String oauthProviderUrl = getOAuthorizeURL;
			...
			oauthProviderUrl += "&scope=email profile"; //No I18N
